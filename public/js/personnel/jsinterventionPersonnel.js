...
function intervention(id){
    ...
    $("#titre").replaceWith("<div id='titre2' style='font-family: police2; color: green; font-size: 20px; font-weight: bold;'><iS style='font-size: 25px;'>&curren;</iS> INTERVENTION DE L'AGENT </div>");	
    ...
    $('#terminer').click(function(){
    	...
    	$.ajax({
            ...
            data: {'id':cle , 'type_intervention':type_intervention , 'service_origine':service_origine , 
            	   'service_accueil':service_accueil , 'date_debut':date_debut, 'date_fin':date_fin, 'motif_intervention':motif_intervention ,
            	   'note':note , 'service_origine_externe':service_origine_externe , 'date_debut_externe':date_debut_externe,
            	   'date_fin_externe':date_fin_externe, 'hopital_accueil':hopital_accueil , 'service_accueil_externe':service_accueil_externe , 
            	   'motif_intervention_externe':motif_intervention_externe, 'note_externe':note_externe},
    	    success: function(data) {    
    	      //var result = jQuery.parseJSON(data);  
              vart='/simens_derniereversion/public/personnel/personnel/listingintervention';
              $(location).attr("href",vart);            
            },
            error:function(e){console.log(e);alert("Une erreur interne est survenue!");},
            dataType: "html"
