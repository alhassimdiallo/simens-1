...
/*** icons image 1 ***/
	$('#frm input[type="file"]').change(function(){
	    ...
	    $('<div class="zoom_" ><a class="various" id="zooom" href="/simens_derniereversion/public/images_icons/images/1_radio-b.jpg"><img src="/simens_derniereversion/public/images_icons/search_16.png" /></a></div>').insertBefore('div.supp');
...
function image2(){
	...
	/*** icons image 2 ***/
		$('#frm2 input[type="file"]').change(function(){
		    ...
		    $('<div class="zoom_2" ><a class="various" id="zoom2" href="/simens_derniereversion/public/images_icons/images/2_echo.jpg"><img src="/simens_derniereversion/public/images_icons/search_16.png" /></a></div>').insertBefore('div.supp2');
		    /**** On créer un input pour gérer le comptage des champs dans le script traitement médical****/
