...
*/
   ...
   date_rv.attr( 'disabled', true );
   heure_rv.attr( 'disabled', true );
	  ...
	  $(function(){
         ...
         $('#ListeConsultationPatient').each(function() {
             ...
             for (var page = 0; page < numPages; page++) {
               $('<button class="page-number" id="page_number" style="margin-right: 5px; background: #efefef;"></button>').text(page + 1)
